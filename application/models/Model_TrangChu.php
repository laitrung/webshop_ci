...
class Model_TrangChu extends CI_Model {
	...
	public function getPopular(){
		$sql = "SELECT sanpham.*, hinhanh.LoaiAnh, hinhanh.MaSanPham, hinhanh.DuongDan AS duongdananh FROM sanpham,hinhanh WHERE hinhanh.MaSanPham = sanpham.MaSanPham AND LoaiSanPham = 1 AND hinhanh.LoaiAnh = 1 AND sanpham.TrangThai != 0 ORDER BY sanpham.MaSanPham DESC LIMIT 6;";
		$result = $this->db->query($sql);
		return $result->result_array();
	}

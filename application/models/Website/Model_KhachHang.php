...
class Model_KhachHang extends CI_Model {
	...
	public function getById($makhachhang){
		$sql = "SELECT donhang.*, khachhang.MaKhachHang, khachhang.TenKhachHang FROM donhang, khachhang WHERE donhang.MaKhachHang = khachhang.MaKhachHang AND khachhang.MaKhachHang = ? ORDER BY MaDonHang DESC";

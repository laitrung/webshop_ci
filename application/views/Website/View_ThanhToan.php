							   ...
							   <div class="col-12 mb-40">
								   ...
								   <div class="checkout-payment-method">
									   <div class="single-method">
										   ...
										   <label for="payment_check" class="pay_click">Thanh Toán Khi Nhận Hàng</label>
									   </div>
									   <div class="single-method">
										   <input type="radio" id="payment_bank" name="payment-method" value="2">
										   <label for="payment_bank" class="bank_click">Chuyển Khoản Ngân Hàng</label>
										   <span style="font-family: system-ui; display: block;" class="stk">NGAN HANG: MB BANK <br>SO TAI KHOAN: 1808200156789 <br> CHU TAI KHOAN: LAI DUC TRUNG <br>NOI DUNG: KHACH HANG <?php echo $_SESSION['khachhang']; ?> THANH TOAN DON HANG <?php echo number_format($_SESSION['sumCart']); ?> VND </span>
									   </div>
								   </div>
